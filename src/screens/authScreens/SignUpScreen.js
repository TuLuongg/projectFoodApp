...
const SignUpScreen = ({navigation}) => {
  ...
  //     console.log('Tạo thành công tài khoản');
  //   } catch (error) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView keyboardShouldPersistTaps="always">
        <View style={styles.view1}>
          <Text style={styles.text1}>Tạo tài khoản mới</Text>
        </View>
        ...
        {/* <Formik>
          {props => (
            <View style={styles.view2}>
              <View>
                <Text style={styles.text2}>New on projectFoodApp ?</Text>
              </View>
              ...
              <View style={styles.view15}>
                <Text style={styles.text3}>
                  Bằng cách tạo hoặc đăng nhập vào một tài khoản, bạn
                </Text>
